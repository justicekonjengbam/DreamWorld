...
function StatGraph({ stats }) {
    ...
    return (
        <div className="stat-graph-container">
            <div className="stat-graph-glow" />
            <div className="stat-graph-chart-wrapper">
                <ResponsiveContainer width="100%" height={300}>
                    <RadarChart cx="50%" cy="50%" outerRadius="70%" data={data}>
                        <PolarGrid stroke="var(--glow-accent, rgba(76, 161, 175, 0.3))" />
                        <PolarAngleAxis 
                            dataKey="subject" 
                            tick={{ fill: 'var(--color-text-sub)', fontSize: 12, fontWeight: 600, fontFamily: 'var(--font-body)' }} 
                        />
                        <Radar
                            name="Dreamer Stats"
                            dataKey="A"
                        ...
                        <defs>
                            <linearGradient id="colorGradient" x1="0" y1="0" x2="0" y2="1">
                                ...
                                <stop offset="95%" stopColor="var(--color-accent)" stopOpacity={0.4}/>
                            </linearGradient>
                        </defs>
                    </RadarChart>
                </ResponsiveContainer>
