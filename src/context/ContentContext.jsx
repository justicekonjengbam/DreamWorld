...
export const ContentProvider = ({ children }) => {
    ...
    const addCharacter = async (newChar) => {
        ...
        const payload = {
            ...
            stat_knowledge: parseInt(newChar.stat_knowledge === "" || newChar.stat_knowledge == null ? 50 : newChar.stat_knowledge),
            stat_discipline: parseInt(newChar.stat_discipline === "" || newChar.stat_discipline == null ? 50 : newChar.stat_discipline),
            stat_charisma: parseInt(newChar.stat_charisma === "" || newChar.stat_charisma == null ? 50 : newChar.stat_charisma),
            stat_creativity: parseInt(newChar.stat_creativity === "" || newChar.stat_creativity == null ? 50 : newChar.stat_creativity),
            stat_courage: parseInt(newChar.stat_courage === "" || newChar.stat_courage == null ? 50 : newChar.stat_courage),
            stat_physique: parseInt(newChar.stat_physique === "" || newChar.stat_physique == null ? 50 : newChar.stat_physique),
            stat_empathy: parseInt(newChar.stat_empathy === "" || newChar.stat_empathy == null ? 50 : newChar.stat_empathy),
